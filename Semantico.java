...
public Semantico(int lineas1) throws FileNotFoundException, IOException{ 
    ...
    File archivo = new File("D:\\tipos.txt");
        ...
        extraerSintactico(lineas1);
}

public void extraerSintactico(int lineas1) throws FileNotFoundException, IOException
{
     String bufferIn = "";
     ...
     Extraer e=new Extraer("D:\\simbolos.txt", br, bufferIn, in, lineas1);    
}
}
